    ...
    <div className="section-container">
      <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <motion.div
          ...
          className="relative flex justify-center items-center min-h-[420px] lg:min-h-[600px] mt-10 lg:mt-0"
        >
          {/* Glow */}
          ...
          <div className="relative w-[400px] lg:w-[440px] card-elevated p-0 overflow-hidden z-10">
            ...
            {/* Messages */}
            <div className="px-5 py-5 space-y-4 bg-gradient-to-b from-card to-background/20 min-h-[300px]">
              <motion.div
              ...
              >
                <div className="bg-primary/8 rounded-2xl rounded-tr-sm px-4 py-3 max-w-[320px]">
                  <p className="font-body text-[15px] text-foreground leading-relaxed">
                    Mi hijo se frustra mucho cuando cambiamos la rutina. ¿Cómo lo acompaño sin empeorarlo?
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="bg-card border border-border/40 rounded-2xl rounded-tl-sm px-4 py-3 max-w-[320px] shadow-sm">
                  <p className="font-body text-[15px] text-foreground leading-relaxed">
                    Es muy válido lo que estás sintiendo. Primero valida su emoción y luego anticipa el cambio con apoyos visuales o una mini-rutina. Eso suele bajar la ansiedad y facilitar que coopere. 💚
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="px-5 py-3 border-t border-border/30 bg-card">
              <div className="flex items-center gap-2 bg-muted/30 rounded-xl px-3 py-1.5">
                <p className="font-body text-xs text-muted-foreground flex-1">Escribe tu consulta aquí…</p>

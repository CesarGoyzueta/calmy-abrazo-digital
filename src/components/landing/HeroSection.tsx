  ...
  return (
    ...
    >
      <motion.div
        ...
        className="flex items-center justify-between gap-2 border-b border-border/50 px-4 py-3 xl:px-3.5 xl:py-2.5"
      >
      ...
      <div className="p-3.5 xl:p-3">
        <motion.div variants={previewItemVariants} className="rounded-lg bg-primary/[0.08] px-3.5 py-3 xl:px-3 xl:py-2.5">
  ...
  return (
    ...
    <div className="section-container relative xl:min-h-[652px]">
      <motion.div
        ...
        className="max-w-[660px] pb-6 pt-8 sm:pb-8 sm:pt-12 xl:max-w-[500px] xl:pb-0 xl:pt-12"
      >
